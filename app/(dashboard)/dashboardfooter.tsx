...
import { logoutUser } from "@/slice/userSlice"; //  Import logout action
...
const DashboardLayout = () => {
  ...
  const groupedTasks: Record<string, Task[]> = tasks.reduce((acc, task) => {
    if (!task.startDateTime) return acc;
              ...
              renderItem={({ item }) => (
                  ...
                  >
                    ...
                    <Text style={styles.taskDate}>
                      📅 {item.startDateTime?.split("T")[0] || "No date"}
                    </Text>
                  ...
                  <>
                    <View style={styles.modalTaskInfo}>
                      ...
                      <Text style={styles.modalTaskDate}>
                        📅 {selectedTask.startDateTime?.split("T")[0] || "No date"}
                      </Text>
